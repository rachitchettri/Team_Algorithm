...
const SuggestedConnections = () => {
  ...
  const suggestedConnections = [
    ...
    },
    {
      ...
      title: "Software Engineer at Code Nepal",
      mutualConnections: 5,
      connected: true,
    },
  ];
  ...
  const handleConnect = (id) => {
    ...
    // Optionally toggle connection status here
  };

  return (
    <Card className="p-6 sticky ">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-bold text-lg text-gray-800">Suggested Connections</h3>
        <button className="text-sm text-purple-600 font-semibold hover:underline hover:text-purple-800 transition-colors duration-200">
          See all
        </button>
      </div>
      <div className="space-y-4">
