    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label htmlFor="cvText" className="font-semibold mb-1 flex items-center gap-2">
          ...
          <div>
            <label htmlFor="jobRequirement" className="font-semibold mb-1 flex items-center gap-2">
